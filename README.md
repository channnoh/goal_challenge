...
### [ 챌린지 기록 조회 ]
- [x] 유저는 본인의 챌린지 기록을 날짜순으로 조회할 수 있다.
- [x] 같은 챌린지를 진행 중인 다른 유저의 챌린지 기록을 조회할 수 있다.(챌린지 기록은 공개된 경우에만 조회가능하다.)
- [x] 유저는 본인이 참여한 챌린지 목록을 조회할 수 있다.
...
### [ 챌린지 종료 ]
- [x] 챌린지 신청기간이 끝나는 시점에 신청인원이 5명 미만이면 챌린지상태는 실패가 되며 종료된다.
- [x] 챌린지 종료일자 자정에 달성도가 100% 아닌 챌린지 참가는 실패 처리되며 종료된다.
- [x] 챌린지 종료일자 자정에 챌린지의 상태는 챌린지 완료 상태가 된다.
